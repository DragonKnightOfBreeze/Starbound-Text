 ...
 * from the specification file <tt>StarboundTextLexer.flex</tt>
 */
public class StarboundTextLexer implements FlexLexer {
   ...
   */
  public StarboundTextLexer(java.io.Reader in) {
    this.zzReader = in;
  }
    ...
    while (true) {
      ...
      if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
        ...
        switch (zzAction < 0 ? zzAction : ZZ_ACTION[zzAction]) {
          ...
          case 18: break;
          case 9: 
            { yybegin(YYINITIAL); return RESET_MARKER_TOKEN;
            } 
            // fall through
          case 19: break;
          case 10: 
            { yybegin(YYINITIAL); return TRUNCATE_MARKER_TOKEN;
            } 
            // fall through
          case 20: break;
          default:
