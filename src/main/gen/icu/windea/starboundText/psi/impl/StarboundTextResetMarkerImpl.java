...
public class StarboundTextResetMarkerImpl extends ASTWrapperPsiElement implements StarboundTextResetMarker {

  public StarboundTextResetMarkerImpl(@NotNull ASTNode node) {
    super(node);
  }
