...
public abstract class StarboundTextRichTextImpl extends ASTWrapperPsiElement implements StarboundTextRichText {

  public StarboundTextRichTextImpl(@NotNull ASTNode node) {
    super(node);
  }
